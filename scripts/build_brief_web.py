...
<header class="mast">
  <div class="mast__inner">
    <p class="eyebrow">Vision Zero · Evaluation note</p>
...
<p><strong>We should not conclude that protected lanes are ineffective or harmful.</strong>
...
<p>We addressed this the standard way: every treated corridor is compared only against
corridors <strong>in the same borough, with a similar recent injury history</strong>, in
...
<p>If protected lanes changed cyclist safety, we would expect a visible break at
installation — estimates sitting at one level before and a different level after. They do
...
<footer>
<p>Independent analysis of public data. Not affiliated with, endorsed by, or produced for
the New York City Department of Transportation or any city agency. Code, data pipeline and
full reproduction instructions at
